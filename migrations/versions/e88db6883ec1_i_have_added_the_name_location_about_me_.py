"""I have added the name, location, about_me, member_since and last_seen field in the user model to be used for user profiles

Revision ID: e88db6883ec1
Revises: 996ba2fbb6e6
Create Date: 2023-05-25 12:29:15.264544
...
revision = 'e88db6883ec1'
down_revision = '996ba2fbb6e6'
branch_labels = None
depends_on = None
